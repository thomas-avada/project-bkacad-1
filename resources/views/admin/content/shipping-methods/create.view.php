<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      <br />
      <form id="new-shipping-method-form" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype='multipart/form-data' action="/admin/shipping-methods">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" name="shipping_method_code" id="shipping_method_code" required="required" class="form-control col-md-7 col-xs-12">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="number" name="fee" id="fee" required="required" class="form-control col-md-7 col-xs-12" min="0">
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            ...
            <button class="btn btn-primary"
                onclick="
                document.getElementById('new-shipping-method-form').setAttribute('action', '/admin/shipping-methods?back=1');
            ">
              Create and continue
            </button>
